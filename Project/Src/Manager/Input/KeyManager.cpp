...
#pragma region プレイヤー操作
	...
	// 回避
	SET_KEYBOARD(KEY_TYPE::PLAYER_ROWLING, KEY_INPUT_H);
	SET_KEYBOARD(KEY_TYPE::PLAYER_ROWLING, KEY_INPUT_LSHIFT);
	SET_KEYBOARD(KEY_TYPE::PLAYER_ROWLING, KEY_INPUT_LCONTROL);
	SET_C_BUTTON(KEY_TYPE::PLAYER_ROWLING, XINPUT_BUTTON_B);
	SET_C_OTHERS(KEY_TYPE::PLAYER_ROWLING, CONTROLLER_OTHERS::LEFT_TRIGGER);
