...
void Player::SubLoad(void)
{
   ...
   playerHpImageId_[(int)UI_IMAGE::HP_FRAME] = LoadGraph("Data/Image/Player/HP_FRAME.png");
   playerHpImageId_[(int)UI_IMAGE::HP_BAR] = LoadGraph("Data/Image/Player/HP.png");
